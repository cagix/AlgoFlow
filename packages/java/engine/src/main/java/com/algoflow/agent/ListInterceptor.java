...
public class ListInterceptor {
    static class GetInterceptor {
        @Advice.OnMethodExit
        static void onGet(@Advice.This Object instance, @Advice.Origin("#m") String methodName,
    ...
    static class SetInterceptor {
        @Advice.OnMethodExit
        static void onSet(@Advice.This Object instance, @Advice.Origin("#m") String methodName,
                @Advice.Argument(0) int index, @Advice.Argument(1) Object value) {
